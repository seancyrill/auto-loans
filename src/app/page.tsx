...
export default function Hero() {
  ...
  return (
    <section ref={heroRef} className="bg-primary relative flex flex-1 flex-col overflow-hidden">
      {/* Subtle grid */}
      <div
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-7xl flex-1 flex-col px-8 pt-[10dvh] pb-20">
        {/* Badge */}
        <div
